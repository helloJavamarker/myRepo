package com.test.mark.zhang.test.agency.heima.man.interview.day04.boot;

import com.test.mark.zhang.test.agency.heima.man.interview.day02.LoggerUtils;
import com.test.mark.zhang.test.agency.heima.man.interview.day04.boot.sub.Bean1;
...
public class TestExcludeFilter {
    ...
    @Configuration
    @ComponentScan(basePackages = {"com.test.mark.zhang.test.agency.heima.man.interview.day04.boot.sub"},
